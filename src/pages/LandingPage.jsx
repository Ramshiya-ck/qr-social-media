...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-950 via-emerald-900 to-emerald-950 text-emerald-950 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-sm sm:max-w-md">
        <div className="relative rounded-3xl bg-white/95 border border-emerald-100 shadow-[0_24px_80px_rgba(5,46,22,0.25)] backdrop-blur-2xl px-6 py-8 sm:px-8 sm:py-10">
          ...
          <div className="relative flex flex-col items-center text-center space-y-5">
            <div className="relative">
              ...
              <div className="relative h-24 w-24 sm:h-28 sm:w-28 rounded-full border border-emerald-100 bg-white overflow-hidden shadow-xl shadow-emerald-900/20 ring-4 ring-emerald-50">
                <img
